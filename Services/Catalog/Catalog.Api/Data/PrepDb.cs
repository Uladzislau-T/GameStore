...
namespace catalog.Data
{
  class PrepDb
  {
    public static async void PrepPopulation(IApplicationBuilder app, bool isDev)
    {
      using var serviceScope = app.ApplicationServices.CreateScope();
      await SeedData(serviceScope.ServiceProvider.GetService<Context>(), isDev);
    }

    private static async Task SeedData(Context context, bool isDev)
    {      
